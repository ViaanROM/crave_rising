...
/opt/crave/resync.sh && \
git clone https://github.com/ViaanROM/android_device_oneplus_larry -b Infinity15 device/oneplus/larry && \
...
# Vanilla Build
. build/envsetup.sh && \
lunch lineage_larry-user && make installclean && mka bacon; \
